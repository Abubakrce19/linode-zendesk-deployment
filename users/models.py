...
class CustomUser(AbstractUser):
    ...
    docs_left = models.IntegerField(default=2)
    usage = models.IntegerField(default=0)
    user_plan = models.TextField(default="Free")
    subscription_status = models.CharField(max_length=300,blank=True, null=True)
